 ...
 * Each template provides a full nanobot agent config structure that
...
export interface AgentTemplate {
  ...
  toolCount: number
  config: Omit<NanobotAgentConfig, 'id' | 'workspace' | 'agentDir'>
}
...
/** Build a full nanobot agent config from a template + overrides */
